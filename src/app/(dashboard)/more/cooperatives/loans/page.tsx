...
export default function CooperativesLoansPage() {
  return (
    <main className="space-y-6 md:space-y-8">
      <header>
        <p className="text-sm font-semibold text-primary">Cooperatives</p>
        <h1 className="mt-1 text-xl font-semibold tracking-tight md:text-2xl">Loans</h1>
      </header>
      {phase3FeatureFlags.cooperativeGroups ? (
        <CooperativeGroupsPanel initialView="loans" />
      ) : (
