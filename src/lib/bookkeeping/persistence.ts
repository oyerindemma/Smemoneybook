  ...
  return {
    ...
    permissions: role
      ? {
          ...
          canViewPayroll: hasPermission(role, "payroll:read"),
          canManagePayrollEmployees: hasPermission(role, "payroll:manage_employees"),
          canPreparePayroll: hasPermission(role, "payroll:prepare"),
          canReviewPayroll: hasPermission(role, "payroll:review"),
          canApprovePayroll: hasPermission(role, "payroll:approve"),
          canExportPayroll: hasPermission(role, "payroll:export"),
          canPostPayrollExpense: hasPermission(role, "payroll:post_expense"),
          canViewPayrollSensitive: hasPermission(role, "payroll:view_sensitive"),
